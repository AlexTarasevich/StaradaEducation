...
// Одним из главных преимуществ цикла for...of является то, что он прост в использовании. Он позволяет итерировать массив без необходимости указывать индексы. 
// Вместо этого мы можем обращаться к элементам массива, используя переменную task, которая будет иметь значение каждого элемента массива по очереди. Это делает наш код более читаемым и понятным.